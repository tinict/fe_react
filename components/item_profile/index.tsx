            ...
            <div className="flex justify-between items-center p-4 rounded-lg">
                        ...
                        <>
                            <div className="w-full bg-white rounded-lg">
                                <Input
                                    ...
                                    onChange={(e) => setEditUser({ ...content.profile, [`${content.type}`]: e.target.value })}
                                />
                ...
                <div>
                    <Dropdown >
                        <DropdownTrigger>
                            <Button
                                className="w-8 h-8 flex items-center justify-center text-gray-700 bg-gray-200 hover:text-gray-900 focus:outline-none rounded-full shadow"
                            >
